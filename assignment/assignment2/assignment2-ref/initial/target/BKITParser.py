...
class BKITParser ( Parser ):
    ...
    class GlobdeclpartContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitGlobdeclpart" ):
                return visitor.visitGlobdeclpart(self)
            else:
                return visitor.visitChildren(self)
    ...
    class FuncdeclspartContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitFuncdeclspart" ):
                return visitor.visitFuncdeclspart(self)
            else:
                return visitor.visitChildren(self)
    ...
    class TailvarContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitTailvar" ):
                return visitor.visitTailvar(self)
            else:
                return visitor.visitChildren(self)
    ...
    class VariableinitContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitVariableinit" ):
                return visitor.visitVariableinit(self)
            else:
                return visitor.visitChildren(self)
    ...
    class ArraydeclsContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitArraydecls" ):
                return visitor.visitArraydecls(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Arraylit_Context(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitArraylit_" ):
                return visitor.visitArraylit_(self)
            else:
                return visitor.visitChildren(self)
    ...
    class TaildimContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitTaildim" ):
                return visitor.visitTaildim(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Parameterlist_Context(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitParameterlist_" ):
                return visitor.visitParameterlist_(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Argumentslist_Context(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitArgumentslist_" ):
                return visitor.visitArgumentslist_(self)
            else:
                return visitor.visitChildren(self)
